...
export function AdminDashboard() {
  ...
  return (
    <div>
      ...
      <CreateWordModal open={createWordOpen} onOpenChange={setCreateWordOpen} onCreated={handleWordCreated} />
      <ImportCorpusModal open={importCorpusOpen} onOpenChange={setImportCorpusOpen} onImported={handleImported} />
